...
cp $BIN_PATH/modules/iterm/hushlogin $HOME/.hushlogin
cp $BIN_PATH/modules/iterm/tmux.conf $HOME/.tmux.conf
...
/usr/libexec/PlistBuddy -c "Merge '$HOME/.config/dotfiles/modules/iterm/themes/DoomOne.itermcolors' 'Custom Color Presets':'DoomOne'" ~/Library/Preferences/com.googlecode.iTerm2.plist

/usr/libexec/PlistBuddy -c "Add 'Custom Color Presets':'Atom' dict" ~/Library/Preferences/com.googlecode.iTerm2.plist
/usr/libexec/PlistBuddy -c "Merge '$HOME/.config/dotfiles/modules/iterm/themes/Atom.itermcolors' 'Custom Color Presets':'Atom'" ~/Library/Preferences/com.googlecode.iTerm2.plist
