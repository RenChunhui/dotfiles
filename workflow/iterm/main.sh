...
/usr/libexec/PlistBuddy -c "Merge '$HOME/.config/dotfiles/workflow/iterm/themes/ayu.itermcolors' 'Custom Color Presets':'ayu'" ~/Library/Preferences/com.googlecode.iTerm2.plist
...
/usr/libexec/PlistBuddy -c "Merge '$HOME/.config/dotfiles/workflow/iterm/themes/ayu_light.itermcolors' 'Custom Color Presets':'ayu_light'" ~/Library/Preferences/com.googlecode.iTerm2.plist
...
/usr/libexec/PlistBuddy -c "Merge '$HOME/.config/dotfiles/workflow/iterm/themes/DoomOne.itermcolors' 'Custom Color Presets':'DoomOne'" ~/Library/Preferences/com.googlecode.iTerm2.plist
