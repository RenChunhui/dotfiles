...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(os_icon root_indicator dir background_jobs status vcs dir_writable)
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status rbenv virtualenv ram battery)
